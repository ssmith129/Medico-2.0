...
const UnifiedEmail = () => {
  ...
  // Mock unified email data combining regular and AI-enhanced emails
  const mockUnifiedEmails: EmailMessage[] = [
    {
      id: "email-1",
      from: "Dr. Sarah Chen",
      ...
      labels: ["Emergency", "Patient Care"],
      folder: "Inbox",
      isStarred: false
    },
    {
      id: "email-2",
      from: "Justin Lapointe",
      subject: "Client Dashboard",
      preview: "It seems that recipients are receiving notifications about the new dashboard updates...",
      ...
      aiClassification: {
        ...
        tags: ["dashboard", "client", "notifications"],
    ...
    },
    {
      ...
      from: "Rufana",
      subject: "UI project",
      preview: "Regardless, you can usually expect an increase in performance with the new interface updates...",
    ...
    },
    {
      id: "email-5",
      from: "Cameron Drake",
      subject: "You're missing important updates",
      preview: "Here are a few catchy email subject line examples that might help with your campaign...",
      ...
      aiClassification: {
        ...
        tags: ["marketing", "updates", "campaign"],
    ...
    },
    {
      ...
      preview: "Sarah Johnson has requested to reschedule her cardiology appointment due to family emergency...",
  ...
  useEffect(() => {
    setEmails(mockUnifiedEmails);
    // Calculate AI insights
    setAiInsights({
      totalProcessed: mockUnifiedEmails.length,
      criticalCount: mockUnifiedEmails.filter(e => e.priority === 'critical').length,
      avgResponseTime: '2.4h',
      complianceRate: 98.5,
      actionRequiredCount: mockUnifiedEmails.filter(e => e.aiClassification.actionRequired && !e.isRead).length
    });
  }, []);

  // Filter emails based on AI criteria when AI mode is enabled
  const filteredEmails = useMemo(() => {
    ...
    if (isAIMode) {
      ...
      // Regular email sorting by timestamp
      filtered = emails.sort((a, b) => b.timestamp.getTime() - a.timestamp.getTime());
    }
              ...
              <div className="slimScrollDiv">
                <div className="active slimscroll">
                  <div className="slimscroll-active-sidebar">
                    <div className="p-3">
                      {/* AI Toggle Header */}
                      <div className="ai-toggle-header mb-3">
                        ...
                        {isAIMode && (
                          <div className="ai-metrics mt-2">
                            <div className="row g-2 text-center">
                              <div className="col-4">
                                <div className="ai-metric">
                                  <h6 className="mb-0 fw-bold text-danger fs-12">{aiInsights.criticalCount}</h6>
                                  <small className="text-muted">Critical</small>
                                </div>
                              </div>
                              <div className="col-4">
                                <div className="ai-metric">
                                  <h6 className="mb-0 fw-bold text-warning fs-12">{aiInsights.actionRequiredCount}</h6>
                                  <small className="text-muted">Action Needed</small>
                                </div>
                              </div>
                              <div className="col-4">
                                <div className="ai-metric">
                                  <h6 className="mb-0 fw-bold text-success fs-12">{Math.round(aiInsights.complianceRate)}%</h6>
                      ...
                      <div className="border bg-white rounded p-2 mb-3">
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <p className="fs-14">
                              {isAIMode ? 'Admin • AI Enhanced' : 'Jnh343@example.com'}
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mt-4">
                        <div className="d-flex align-items-center justify-content-between mb-2">
                          <h5 className="mb-0">{isAIMode ? 'AI-Sorted Emails' : 'Emails'}</h5>
                          {isAIMode && (
                        ...
                        <div className="d-block mb-3 pb-3 border-bottom email-tags">
                          ...
                          >
                            <span className="d-flex align-items-center fw-medium">
                              <i className={isAIMode ? "ti ti-robot text-primary me-2" : "ti ti-inbox text-gray me-2"} />
                              {isAIMode ? 'AI Triage Inbox' : 'Inbox'}
                            </span>
                      ...
                      <div className="border-bottom mb-3 pb-3">
                        <div className="d-flex align-items-center justify-content-between mb-2">
                          <h5>{isAIMode ? 'AI Labels' : 'Labels'}</h5>
                          <Link to="#">
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <div className="view-all mt-2">
                              <Link to="#" className="viewall-button-2 fw-medium" onClick={handleToggle2}>
                      ...
                      <div>
                        <div className="d-flex align-items-center justify-content-between mb-2">
                          <h5>{isAIMode ? 'Departments' : 'Folders'}</h5>
                          <Link to="#">
                            <i className="ti ti-square-rounded-plus-filled text-primary fs-16" />
                          </Link>
                        </div>
                ...
                <div className="active slimscroll">
                  <div className="slimscroll-active-sidebar">
                    ...
                    <div className="p-3">
                      <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                        <div>
                          <h5 className="mb-1 d-flex align-items-center">
                            {isAIMode && <i className="ti ti-robot text-primary me-2"></i>}
                            {isAIMode ? 'AI-Enhanced Inbox' : 'Inbox'}
                          </h5>
                          <div className="d-flex align-items-center">
                        ...
                        <div className="d-flex align-items-center">
                          <div className="position-relative input-icon me-3">
                            <input
                              ...
                              placeholder={isAIMode ? "AI Smart Search..." : "Search Email"}
                            />
                      ...
                      {/* AI Insights Bar */}
                      {isAIMode && (
                        <div className="ai-insights-bar bg-light rounded p-2 mt-3">
                          <div className="row g-2 text-center">
                            <div className="col-3">
                          ...
                          <div className="d-flex align-items-center mb-2">
                            ...
                            <div className="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                              ...
                              <div className="flex-fill">
                                  ...
                                  <div className="d-flex align-items-center">
                                    <div className="dropdown">
                                      ...
                                      <ul className="dropdown-menu dropdown-menu-end p-3">
                                        ...
                                        <li><Link className="dropdown-item rounded-1" to="#">Reply All</Link></li>
                                        ...
                                        <li><Link className="dropdown-item rounded-1" to="#">Mark As Unread</Link></li>
                                ...
                                {/* AI Insights */}
                                <div className="email-insights mt-2">
                                      ...
                                      {isAIMode && (
                                        <>
                                          <small className="text-muted fs-10">
                                            AI: {Math.round(email.aiClassification.confidence * 100)}%
                                          </small>
                                          <small className="text-muted fs-10">
